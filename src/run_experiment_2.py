...
def run():
    print(f"\n{'='*60}")
    print(f"  Experiment #2: Deep Full-Text Paper Analysis")
    ...
    with open(DATA_DIR / "experiment_002_results.json", "w") as f:
        json.dump(results, f, indent=2, default=str)

    # Write report
    report = f"""# Experiment #2: Deep Full-Text Analysis of HD Research Papers
...
"""
    ...
    with open(DATA_DIR / "experiment_002_report.md", "w") as f:
        f.write(report)
    ...
    print(f"  Report: data/experiment_002_report.md")
    print(f"{'='*60}\n")
