...
def run():
    ...
    with open(DATA_DIR / "experiment_003_gemma4_results.json", "w") as f:
...
"""
    ...
    with open(DATA_DIR / "experiment_003_gemma4_report.md", "w") as f:
        f.write(report)
    ...
    print(f"  Report: data/experiment_003_gemma4_report.md")
    print(f"{'='*60}\n")
