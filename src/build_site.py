...
<nav class="flex justify-between items-center px-4 md:px-8 h-16 border-b border-gray-100 sticky top-0 glass z-50">
  <div class="flex items-center gap-4 md:gap-8">
    ...
    <div id="mobile-nav" class="mobile-menu hidden md:flex items-center gap-6 text-sm font-medium">
      <a href="#ai-lens" class="text-teal-600 hover:text-teal-700 py-2">AI + HD</a>
      <a href="#papers" class="text-gray-500 hover:text-gray-900 py-2">Papers</a>
...
<section id="ideas" class="py-16 px-4 md:px-8">
  <div class="max-w-5xl mx-auto">
    ...
    <p class="text-center text-sm text-gray-400 mt-6">These hypotheses are generated by our AI research agent and published for community discussion. <a href="https://github.com/jravinder/hd-research-agent" target="_blank" class="text-teal-600 underline">View methodology on GitHub</a>.</p>
  </div>
</section>
...
<section id="resources" class="py-16 px-4 md:px-8 bg-teal-50/30">
  <div class="max-w-5xl mx-auto">
    <div class="text-center mb-10">
      <div class="text-sm font-bold text-teal-600 uppercase tracking-wider mb-2">Start Here</div>
      <h2 class="text-2xl md:text-3xl font-bold text-gray-900">Resources for Patients, Families + Researchers</h2>
      <p class="text-gray-500 mt-2">Trusted organizations doing essential work. We link to them because they're the experts.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
...
<footer class="bg-gray-900 text-white py-12 px-4 md:px-8">
  <div class="max-w-5xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
      <div>
        <p class="font-bold text-lg mb-2">HD Research Hub</p>
        <p class="text-gray-400 text-sm leading-relaxed">An open-source project exploring the art of the possible. Built with care by researchers who believe AI can help accelerate the path to treatments.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <div class="flex flex-col gap-2 text-sm">
          ...
          <a href="https://github.com/jravinder/hd-research-agent" target="_blank" class="text-teal-400 hover:underline">Open Source (MIT License)</a>
        </div>
      </div>
    </div>
