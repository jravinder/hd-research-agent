  ...
  <div class="max-w-5xl mx-auto">
    <div class="bg-gradient-to-br from-green-50 to-teal-50 border border-green-200 rounded-2xl p-6 md:p-8">
      <div class="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-bold text-gray-900 mb-2">New Here? Start With the Official Resources.</h2>
          <p class="text-gray-600 text-sm leading-relaxed mb-4">If you or someone you love is affected by Huntington's Disease, please start with the trusted organizations below — <a href="https://hdsa.org" target="_blank" class="text-teal-600 underline font-medium">HDSA</a>, <a href="https://en.hdbuzz.net" target="_blank" class="text-teal-600 underline font-medium">HDBuzz</a>, and <a href="https://www.hdyo.org" target="_blank" class="text-teal-600 underline font-medium">HDYO</a>. They provide expert medical guidance, support groups, and verified information that we cannot.</p>
          <p class="text-gray-600 text-sm leading-relaxed mb-4">This site is different — it's a <strong>data science experiment</strong>, not a medical resource. We use AI to scan research papers and explore ideas. Think of it as a lab notebook that happens to be public. It may be useful as a supplement to official resources, but it should never replace them.</p>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div class="bg-white rounded-xl p-4 border border-gray-200">
              <div class="font-bold text-gray-900 text-sm mb-1">For medical information</div>
              <p class="text-xs text-gray-500 mb-2">Go to <a href="https://hdsa.org" target="_blank" class="text-teal-600 underline">HDSA</a> or <a href="https://en.hdbuzz.net" target="_blank" class="text-teal-600 underline">HDBuzz</a> — they have doctors and scientists reviewing every word. We don't.</p>
            </div>
            <div class="bg-white rounded-xl p-4 border border-gray-200">
              <div class="font-bold text-gray-900 text-sm mb-1">Curious about the research landscape?</div>
              <p class="text-xs text-gray-500 mb-2">Browse our dashboard — it pulls live data from PubMed and ClinicalTrials.gov. Or <a href="chat.html" class="text-teal-600 underline">ask our AI</a> a question. It cites sources but is not a substitute for expert advice.</p>
            </div>
            <div class="bg-white rounded-xl p-4 border border-gray-200">
              <div class="font-bold text-gray-900 text-sm mb-1">Want to contribute?</div>
              <p class="text-xs text-gray-500 mb-2">The most impactful thing you can do is <a href="https://www.enroll-hd.org" target="_blank" class="text-teal-600 underline">join Enroll-HD</a> (the global HD study) or <a href="https://hdsa.org/get-involved/" target="_blank" class="text-teal-600 underline">volunteer with HDSA</a>. No technical skills needed.</p>
            </div>
          </div>
          <p class="text-xs text-gray-400">We are data scientists, not doctors. Nothing on this site is medical advice. Our AI-generated ideas have not been reviewed by HD experts or tested clinically. Please always consult healthcare professionals.</p>
        </div>
      </div>
    </div>
  </div>
