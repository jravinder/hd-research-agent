  ...
  <div class="flex justify-between items-center max-w-7xl mx-auto px-6 h-20">
    <div class="flex items-center gap-4 md:gap-8">
      ...
      <div id="mobile-nav" class="mobile-menu hidden md:flex items-center gap-8 text-sm font-medium">
        <a href="#papers" class="text-slate-600 hover:text-amber-700 transition-colors">Research</a>
        <a href="#trials" class="text-slate-600 hover:text-amber-700 transition-colors">Trials</a>
        <a href="#ideas" class="text-slate-600 hover:text-amber-700 transition-colors">Ideas</a>
        <a href="#resources" class="text-slate-600 hover:text-amber-700 transition-colors">Resources</a>
        <a href="about.html" class="text-slate-600 hover:text-amber-700 transition-colors">About</a>
      </div>
    </div>
  ...
  <div class="max-w-5xl mx-auto">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
      <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-amber-100">
        ...
        <div class="text-xs text-slate-500 font-medium mt-1">Recent Papers</div>
      </div>
      <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-green-100">
        ...
        <div class="text-xs text-slate-500 font-medium mt-1">Active Trials</div>
      </div>
      <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-orange-100">
        ...
        <div class="text-xs text-slate-500 font-medium mt-1">Recruiting Now</div>
      </div>
      <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-purple-100">
        ...
        <div class="text-xs text-slate-500 font-medium mt-1">Known Targets</div>
      </div>
    </div>
    <p class="text-xs text-slate-400 text-center mt-4">Updated {updated_str} — auto-refreshed daily from PubMed, ClinicalTrials.gov, HDBuzz, Open Targets</p>
  </div>
</section>
  ...
  <div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-x-auto">
      <table class="w-full text-left min-w-[700px]">
        <thead>
          <tr class="bg-[#f8f4e4] border-b border-gray-200">
...
<section id="ideas" class="py-16 px-4 md:px-8">
  <div class="max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div class="border border-gray-200 bg-[#f8f4e4]/30 rounded-xl p-5 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-3">
  ...
  <div class="max-w-5xl mx-auto">
    <div class="bg-gradient-to-br from-green-50 to-amber-50 border border-green-200 rounded-2xl p-6 md:p-8">
      <div class="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-bold text-gray-900 mb-2">Who This Is For</h2>
          <p class="text-gray-600 text-sm leading-relaxed mb-4">This is an <strong>experimentation playground</strong> — a place where data scientists, AI engineers, ML researchers, bioinformaticians, and curious builders can explore how AI tools apply to a real-world problem: Huntington's Disease drug discovery.</p>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div class="bg-white rounded-xl p-4 border border-gray-200">
              <div class="font-bold text-gray-900 text-sm mb-1">Data Scientists + AI/ML Engineers</div>
              <p class="text-xs text-gray-500 mb-2">Run our autonomous research agents. Fork the repo. Try different models. Add experiments. This is open-source infrastructure you can build on.</p>
            </div>
            <div class="bg-white rounded-xl p-4 border border-gray-200">
