...
<section class="relative rounded-xl overflow-hidden min-h-[500px] flex items-center justify-center text-center p-8 md:p-12 mx-4 md:mx-6 mt-6">
  ...
  <div class="relative z-10 space-y-6 max-w-3xl">
    <div class="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-white/90 backdrop-blur-sm">
      Public HD Research
    </div>
    <h1 class="text-5xl md:text-7xl font-extrabold tracking-tighter text-white text-shadow-hero leading-tight">
      Make Huntington's disease legible.
    </h1>
    <p class="text-lg md:text-xl text-white/90 font-medium max-w-2xl mx-auto leading-relaxed">
      Learn the landscape, inspect the evidence, and work directly against the HD corpus. This is a public research workspace for turning a messy disease area into something people can actually study.
    </p>
    <div class="flex flex-wrap justify-center gap-4">
      <a href="chat.html" class="bg-amber-500 text-white px-8 py-4 rounded-lg font-bold text-lg hover:shadow-[0_0_20px_rgba(245,158,11,0.5)] transition-all">Work the Corpus</a>
      <a href="learn.html" class="bg-white/10 backdrop-blur-md text-white border border-white/30 px-8 py-4 rounded-lg font-bold text-lg hover:bg-white/20 transition-all">Learn the Landscape</a>
    </div>
  </div>
</section>
...
<section id="pillars" class="py-16 px-4 md:px-8">
  <div class="max-w-5xl mx-auto">
    <div class="text-center mb-12">
      <div class="text-sm font-bold text-amber-700 uppercase tracking-wider mb-2">How To Use It</div>
      <h2 class="text-2xl md:text-3xl font-bold text-stone-900">Three Ways This Becomes Useful</h2>
      <p class="text-stone-700 mt-2 max-w-2xl mx-auto">The point is not to sound like a biotech platform. The point is to help someone understand HD faster, ask better questions, and stay anchored to real evidence.</p>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
      <div class="bg-gradient-to-br from-amber-50 to-amber-100/50 border border-amber-200 rounded-2xl p-6">
        ...
        <h3 class="text-lg font-bold text-stone-900 mb-2">Learn the Landscape</h3>
        <p class="text-stone-700 text-sm">The learning app turns HD into a navigable field map: mechanisms, targets, biomarkers, trials, and current therapeutic bets without forcing people to start from raw literature.</p>
        <a href="learn.html" class="text-amber-700 text-sm font-medium mt-3 inline-flex items-center gap-1">Open the field map <span class="material-symbols-outlined text-sm">arrow_forward</span></a>
      </div>
      <div class="bg-gradient-to-br from-orange-50 to-orange-100/50 border border-orange-200 rounded-2xl p-6">
        ...
        <h3 class="text-lg font-bold text-stone-900 mb-2">Work the Corpus</h3>
        <p class="text-stone-700 text-sm">The chat app acts like a research interface over the corpus: ask about AMT-130, somatic expansion, or trial signals and get answers that stay attached to sources and current context.</p>
        <a href="chat.html" class="text-orange-600 text-sm font-medium mt-3 inline-flex items-center gap-1">Work the corpus <span class="material-symbols-outlined text-sm">arrow_forward</span></a>
      </div>
      <div class="bg-gradient-to-br from-green-50 to-green-100/50 border border-green-200 rounded-2xl p-6">
        ...
        <h3 class="text-lg font-bold text-stone-900 mb-2">Built on Live Research Data</h3>
        <p class="text-stone-700 text-sm">Under both apps is the real differentiator: a refresh pipeline pulling papers, trials, feeds, and experiment outputs into an inspectable HD evidence layer instead of a black-box demo.</p>
        <a href="research.html" class="text-green-700 text-sm font-medium mt-3 inline-flex items-center gap-1">Inspect the engine <span class="material-symbols-outlined text-sm">arrow_forward</span></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="bg-gradient-to-br from-white to-amber-50 border border-amber-200 rounded-3xl p-6 md:p-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div class="bg-[#fdf9e9] rounded-2xl border border-stone-200 p-5">
          <div class="text-xs font-bold uppercase tracking-wider text-amber-700 mb-2">For Orientation</div>
          <h3 class="text-lg font-bold text-stone-900 mb-2">Use Learning to Get Oriented Fast</h3>
          <p class="text-sm text-stone-700">Start with the field map when you need the disease model, major programs, and vocabulary before diving into specific papers.</p>
        </div>
        <div class="bg-[#fdf9e9] rounded-2xl border border-stone-200 p-5">
          <div class="text-xs font-bold uppercase tracking-wider text-orange-600 mb-2">For Investigation</div>
          <h3 class="text-lg font-bold text-stone-900 mb-2">Use Chat to Work the Corpus</h3>
          <p class="text-sm text-stone-700">Ask about a mechanism, treatment, or trial, then use the linked sources and reports to verify the answer against the corpus.</p>
        </div>
        <div class="bg-[#fdf9e9] rounded-2xl border border-stone-200 p-5">
          <div class="text-xs font-bold uppercase tracking-wider text-green-700 mb-2">For Currency</div>
          <h3 class="text-lg font-bold text-stone-900 mb-2">Ground Everything in Refreshing Data</h3>
          <p class="text-sm text-stone-700">The automation layer keeps the papers, trials, and experiment outputs current so both apps have something defensible to stand on.</p>
        </div>
      </div>
    </div>
  </div>
